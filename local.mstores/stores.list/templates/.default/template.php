...
foreach ($arResult['STORES'] as $store) {
    ...
    $rows[] = array(
        ...
        'actions' => array(
            array(
                'TITLE' => Loc::getMessage('MSTORES_ACTION_VIEW_TITLE'),
                'TEXT' => Loc::getMessage('MSTORES_ACTION_VIEW_TEXT'),
                'ONCLICK' => 'BX.Crm.Page.open(' . Json::encode($viewUrl) . ')',
                'DEFAULT' => true
            ),
            array(
                'TITLE' => Loc::getMessage('MSTORES_ACTION_EDIT_TITLE'),
                'TEXT' => Loc::getMessage('MSTORES_ACTION_EDIT_TEXT'),
                'ONCLICK' => 'BX.Crm.Page.open(' . Json::encode($editUrl) . ')',
            ),
            array(
                'TITLE' => Loc::getMessage('MSTORES_ACTION_DELETE_TITLE'),
                'TEXT' => Loc::getMessage('MSTORES_ACTION_DELETE_TEXT'),
...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        'EXTENSION' => array(
            ...
            'MESSAGES' => array(
                'deletionDialogTitle' => Loc::getMessage('MSTORES_DELETE_DIALOG_TITLE'),
                'deletionDialogMessage' => Loc::getMessage('MSTORES_DELETE_DIALOG_MESSAGE'),
                'deletionDialogButtonTitle' => Loc::getMessage('MSTORES_DELETE_DIALOG_BUTTON'),
            )
        ),
    ),
    $this->getComponent(),
